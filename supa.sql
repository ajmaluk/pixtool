...
insert into tools (name, slug) values
  ...
  ('Rotate Photo Online', 'image-tools/rotate'),
  ('Image Compressor Pro', 'image-tools/compress'),
  ('Universal Format Studio', 'image-tools/convert'),
  ('Asset Shield', 'image-tools/watermark'),
  ('Mirror Forge', 'image-tools/flip'),
  ('Monochrome Studio', 'image-tools/grayscale'),
  ('AI Resolution Master', 'image-tools/upscale'),
  ('AI Photo Revival', 'image-tools/restore'),
  ('Portfolio Builder', 'image-tools/image-to-pdf'),
  ('AI Transparency Studio', 'image-tools/remove-background'),
  ('PDF Merger Pro', 'pdf-tools/merge'),
  ('PDF Slicer Forge', 'pdf-tools/split'),
  ('PDF Shrink Studio', 'pdf-tools/compress'),
  ('PDF Format Master', 'pdf-tools/convert'),
  ('PDF Vault', 'pdf-tools/protect'),
  ('PDF Brand Manager', 'pdf-tools/watermark'),
  ('PDF Layout Studio', 'pdf-tools/reorder'),
  ('PDF to Word Converter', 'pdf-tools/to-word'),
  ('PDF to Excel [Pro]', 'pdf-tools/to-excel'),
  ('PDF to PPT [Pro]', 'pdf-tools/to-ppt'),
  ('PDF Key Master', 'pdf-tools/unlock'),
  ('PDF OCR Engine', 'pdf-tools/ocr'),
  ('PDF Editor [Pro]', 'pdf-tools/edit'),
  ('Free Temp Mail 2026 [Safe]', 'temp-mail'),
  ('10 Minute Mail', 'temp-mail/10-minute-mail'),
  ('Identity Switch', 'temp-mail/change-email'),
  ('Fake Email Generator', 'fake-email'),
  ('Disposable Email Address', 'disposable-email'),
  ('Throwaway Email Inbox', 'throwaway-email'),
  ('Identity Forge', 'identity-forge'),
  ('Burner Inbox', 'burner-inbox'),
  ('Ghost Inbox', 'ghost-inbox'),
  ('Typing Master', 'typing-test'),
  ('Universal QR Scanner', 'qr-scanner'),
  ('Free QR Code Generator [Pro]', 'qr-generator'),
  ('Code Diff', 'code-diff'),
  ...
  ('Todo List', 'productivity-tools/todo'),
  ('Kanban Board', 'productivity-tools/kanban'),
  ('NotePad Pro', 'productivity-tools/notepad'),
  ('Drawing Board', 'productivity-tools/drawing-board'),
  ('File Vault', 'productivity-tools/file-manager'),
  ('Focus Clock', 'productivity-tools/pomodoro'),
  ('Sticky Notes', 'productivity-tools/sticky-notes'),
  ('Habit Tracker', 'productivity-tools/habit-tracker')
