export const UTILITY_SEO_CONTENT = {
    'temp-mail': {
      ...
      alternativeTo: ["TempMail.io", "GuerrillaMail", "10MinuteMail", "Nada"],
    ...
    'qr-scanner': {
      ...
      keywords: "qr scanner online, scan qr code browser, camera qr reader, free qr code scanner, webcam qr scan, qr code reader online, qr code scanner no app",
      description: "Scan QR codes instantly using your browser's camera. Our online QR reader requires no application download—just point your webcam or phone camera for immediate results. 100% private and secure.",
      benefits: ["No App Download Required", "Mobile camera support", "Desktop webcam compatibility", "Local Privacy Focus", "Instant URL detection", "High-speed processing", "Free and unlimited"],
    ...
    'qr-generator': {
      ...
      faq: [
        { q: "Are these QR codes dynamic or static?", a: "These are permanent static QR codes. They contain the data directly and will work forever without any redirects or expiration." },
        { q: "Can I use these QR codes on printed materials?", a: "Yes! We generate high-density codes suitable for business cards, flyers, and professional signage." },
        { q: "Is my data stored when I generate a QR code?", a: "No. The generation happens entirely in your browser. We never see or store the information you encode." },
        { q: "What is the maximum character limit for a QR code?", a: "You can encode up to 4,296 alphanumeric characters, though we recommend keeping URLs short for better scannability." }
      ]
    },
    '10-minute-mail': {
    ...
    'change-email': {
      ...
      alternativeTo: ["Gmail", "Outlook", "ProtonMail (for temp use)"],
    ...
    'fake-email': {
      ...
      alternativeTo: ["YOPmail", "Mailinator", "FakeMail.net"],
    ...
    'typing-test': {
      ...
      faq: [
        ...
        { q: "Can I improve my typing speed using this tool?", a: "Absolutely! Regular practice builds muscle memory. We recommend focusing on accuracy first, as speed naturally follows." },
