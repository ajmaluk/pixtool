export const PDF_SEO_CONTENT = {
    merge: {
      ...
      faq: [
        { q: "Is there a limit on the number of files I can combine?", a: "No, you can combine as many files as your browser can handle." },
    ...
    split: {
      ...
      faq: [
        ...
        { q: "Can I split a password-protected PDF?", a: "Yes, once you enter the password to open it in your browser, you can extract any pages you need." }
      ]
    },
    compress: {
      ...
      faq: [
        { q: "How can I reduce the file size of a PDF?", a: "Upload your file to our compressor, select the compression level, and click 'Compress PDF'. Our tool will shrink the file size locally." },
        { q: "Will my PDF lose quality if I make it smaller?", a: "We use advanced algorithms to maintain text clarity and visual fidelity even when significantly reducing the file size." },
    ...
    convert: {
      ...
      alternativeTo: ["PDF2JPG", "SmallPDF", "CloudConvert"],
      ...
      faq: [
        { q: "What is the resolution of the output?", a: "We provide high-fidelity renderings, typically equivalent to 300 DPI for professional use." },
        { q: "Can I convert protected PDFs?", a: "Yes, as long as you have the password to open them in your browser." },
        { q: "Is it free for large PDFs?", a: "Yes, there are no page or size limits beyond your browser's memory." }
      ]
    },
    protect: {
      ...
      faq: [
        { q: "How strong is the encryption used?", a: "We use AES-256 encryption, which is the industry standard for securing government and financial documents." },
    ...
    reorder: {
      ...
      alternativeTo: ["ILovePDF", "SmallPDF", "PDFChef"],
      ...
      faq: [
        { q: "Is there a visual preview?", a: "Yes, every page is rendered as a thumbnail to help you organize accurately." },
        { q: "Can I delete pages while reordering?", a: "Yes, you can remove unwanted pages directly in the reorder interface." },
        { q: "Does the quality decrease?", a: "No, we maintain the original resolution of every page during the reordering." }
      ]
    },
    'to-word': {
    ...
    'to-excel': {
      ...
      alternativeTo: ["Tabula", "SmallPDF", "ILovePDF"],
    ...
    'to-ppt': {
      ...
      alternativeTo: ["SmallPDF", "ILovePDF", "Canva"],
